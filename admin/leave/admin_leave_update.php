...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE leave_record SET roll_no='$roll_no', room_no='$room_no', departure_date='$departure_date', arrival_date='$arrival_date' where roll_no='$roll_no' ";
    ...
    if ($result) {
        header("Location: admin_leave.php?roll_no=$roll_no");
        exit;
    }
}
?>
...
<body>
    ...
    <div class="leave-container">
        <form action="admin_leave_update.php" method="post">
            <div class="roll_no">
