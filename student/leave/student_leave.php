    ...
    <table class="content-table">
        ...
        <tbody>
                ...
                echo 
                    '<tr>
                        ...
                        <form action="student_leave.php" method="POST" >
                            ...
                            <button type="submit" class="btn btn-success" name="received">Arrival Date</button>
                        </form>
                        </td>
                    </tr>';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['received'])) {
                ...
                $query = "UPDATE leave_record SET arrival_date='$currentDate' WHERE roll_no='$roll_no' ";
                $result = mysqli_query($conn, $query);
